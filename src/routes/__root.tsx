...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-display tracking-tight">Esta página não carregou</h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Almeida Empreendimentos — Arquitetura, solidez e valorização" },
      {
        name: "description",
        content:
          "Construtora e incorporadora de alto padrão no litoral norte gaúcho. Residências contemporâneas, empreendimentos residenciais e parcerias estratégicas.",
      },
      { name: "author", content: "Almeida Empreendimentos" },
      { property: "og:title", content: "Almeida Empreendimentos" },
      {
        property: "og:description",
        content: "Arquitetura, solidez e valorização no litoral norte gaúcho.",
      },
